...
public class Familiar extends Turismo {
    ...
    public Familiar (int nPlazas, boolean sillaBebe, String matricula, String marca, String modelo, int cilindrada, Enumerados.TipoCombustible combustible, int nPuertas)
    {
